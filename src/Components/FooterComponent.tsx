...
import linkedin from '../Assets/linkedinNew.jpg'
    ...
    <>
     <div id="ContactMe" className="min-h-[200px]">
          <div className="mx-20 flex justify-between">
            ...
            <Image src={gitLogo} className="mr-2 w-14 lg:w-16 h-auto" alt="github Logo"/>
            ...
            <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/linkedin/linkedin-original.svg" className="mr-2 w-14 lg:w-16 h-auto" />
            {/* <Image src={linkedin} className="mr-2 w-14 lg:w-16 h-auto" alt="linkedin Logo"/> */}
